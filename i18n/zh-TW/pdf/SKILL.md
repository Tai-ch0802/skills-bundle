---
name: pdf
description: "當使用者想對 PDF 檔案做任何處理時，使用此技能。涵蓋：讀取或擷取 PDF 的文字／表格；彙整或合併多個 PDF 為一個；拆分 PDF；旋轉頁面；加入浮水印；建立新的 PDF；填寫 PDF 表單；加密／解密 PDF；擷取圖片；以及對掃描的 PDF 做 OCR 使其可搜尋。當使用者提到 .pdf 檔案，或要求產出 PDF 時，請使用此技能。"
