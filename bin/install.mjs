  ...
  en: {
    ...
    messages: {
      ...
      skillDescriptions: {
        ...
        'gemini-api-dev': 'Gemini API hosted models including Gemini and Gemma 4 — SDK usage, multimodal, function calling, structured output',
        ...
        'vulnerability-scanner': 'Security review and vulnerability scanning methodology. Use when auditing code or infrastructure.',
        ...
        'web-design-guidelines': 'Review UI code for Web Interface Guidelines compliance. Use when auditing web UI.',
  ...
  'zh-TW': {
    ...
    messages: {
      ...
      skillDescriptions: {
        ...
        brainstorming: '蘇格拉底式提問協議 + 使用者溝通。對於複雜需求、新功能或不明確的要求為必填。包含進度報告和錯誤處理。',
        ...
        'gemini-api-dev': '包含 Gemini 及 Gemma 4 的 Gemini API 託管模型 — SDK 使用、多模態、函式呼叫、結構化輸出',
        ...
        'vulnerability-scanner': '安全性審查與漏洞掃描方法論。用於審核程式碼或基礎設施的安全性、檢查漏洞。',
        ...
        'web-design-guidelines': '審查 UI 程式碼是否符合 Web 介面指南。用於審核 Web UI 時。',
        ...
        'skill-creator': '建立新技能、修改與改進現有技能，並衡量技能表現。當使用者想要從頭建立技能、編輯或最佳化現有技能、執行評估以測試技能、透過變異數分析對技能表現進行基準測試，或最佳化技能描述以提高觸發準確性時使用。',
...
const REMOTE_SKILLS = {
  ...
  // --- vudovn/antigravity-kit (upstream path: .agents/skills/<name>) ---
  'api-patterns': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/api-patterns', branch: 'main' },
  'app-builder': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/app-builder', branch: 'main' },
  architecture: { repo: 'vudovn/antigravity-kit', path: '.agents/skills/architecture', branch: 'main' },
  'bash-linux': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/bash-linux', branch: 'main' },
  'behavioral-modes': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/behavioral-modes', branch: 'main' },
  brainstorming: { repo: 'vudovn/antigravity-kit', path: '.agents/skills/brainstorming', branch: 'main' },
  'database-design': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/database-design', branch: 'main' },
  'deployment-procedures': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/deployment-procedures', branch: 'main' },
  'documentation-templates': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/documentation-templates', branch: 'main' },
  'game-development': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/game-development', branch: 'main' },
  'geo-fundamentals': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/geo-fundamentals', branch: 'main' },
  'i18n-localization': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/i18n-localization', branch: 'main' },
  'intelligent-routing': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/intelligent-routing', branch: 'main' },
  'lint-and-validate': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/lint-and-validate', branch: 'main' },
  'mobile-design': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/mobile-design', branch: 'main' },
  'nextjs-react-expert': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/nextjs-react-expert', branch: 'main' },
  'nodejs-best-practices': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/nodejs-best-practices', branch: 'main' },
  'parallel-agents': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/parallel-agents', branch: 'main' },
  'performance-profiling': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/performance-profiling', branch: 'main' },
  'plan-writing': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/plan-writing', branch: 'main' },
  'powershell-windows': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/powershell-windows', branch: 'main' },
  'python-patterns': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/python-patterns', branch: 'main' },
  'red-team-tactics': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/red-team-tactics', branch: 'main' },
  'rust-pro': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/rust-pro', branch: 'main' },
  'seo-fundamentals': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/seo-fundamentals', branch: 'main' },
  'server-management': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/server-management', branch: 'main' },
  'systematic-debugging': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/systematic-debugging', branch: 'main' },
  'tailwind-patterns': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/tailwind-patterns', branch: 'main' },
  'vulnerability-scanner': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/vulnerability-scanner', branch: 'main' },
  'web-design-guidelines': { repo: 'vudovn/antigravity-kit', path: '.agents/skills/web-design-guidelines', branch: 'main' },
