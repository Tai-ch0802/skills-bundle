  ...
  en: {
    ...
    messages: {
      ...
      skillDescriptions: {
        ...
        'gemini-live-api-dev': 'Gemini Live API development — real-time audio/video streaming, WebSockets, native audio, live translation',
  ...
  'zh-TW': {
    ...
    messages: {
      ...
      skillDescriptions: {
        ...
        'gemini-live-api-dev': 'Gemini Live API 開發 — 即時音訊/視訊串流、WebSockets、原生音訊、即時翻譯',
